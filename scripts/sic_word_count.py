...
def process_csv(input_file):
    ...
    word_tally = [
        {
            "words": count,
            "description_count": occurrences,
            "word_list": word_details[count],
        }
    ...
    word_brackets_tally = [
        {
            "words": count,
            "description_count": occurrences,
            "word_list": bracket_word_details[count],
        }
    ...
    word_nonalpha_tally = [
        {
            "words": count,
            "description_count": occurrences,
            "word_list": nonalpha_word_details[count],
        }
    ...
    for count, descriptions in word_details.items():
        for description in descriptions:
            if not re.search(r"[\(\)]", description) and not re.search(
    ...
    return (
        ...
        word_alpha_only_tally,
        bracket_tally,
        words_threshold_or_less,
        alpha_threshold_tally,
    )
...
print(
    f"Descriptions with non-alphabet characters but no brackets: {bracket_tally['non_alpha_no_brackets']}"
)
print(f"Descriptions with {WORDS_THRESHOLD} words or less: {threshold_words}")
print(
    f"Descriptions with {WORDS_THRESHOLD} words or less excluding brackets and non-alphabet characters: {alpha_threshold_words}"
)
